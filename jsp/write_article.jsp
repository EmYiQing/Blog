        ...
        <div style="padding: 5px 8px;">
            <form id="articleForm" method="POST" action="${pageContext.request.contextPath}/ArticleAction_write?author_id=<s:property value="#session.user.u_id" />" name="articleForm">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="文章标题，必填" name="title" id="title"/>
                </div>
                <div class="form-group">
                    <label for="summary">简介</label>
                    <input type="text" class="form-control" placeholder="简介，在首页显示的内容" name="summary" id="summary"/>
                </div>
                <div class="form-group">
